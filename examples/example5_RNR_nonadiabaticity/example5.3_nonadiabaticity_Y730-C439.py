...
rp_read, E_Reac, E_Prod, Vel = np.loadtxt('Y730_C439_flipped_env.dat', unpack=True)
E_Reac *= kcal2eV
E_Prod *= kcal2eV
Vel *= kcal2eV
...
plt.xticks(np.arange(-2.0,3.0,1.0), fontsize=16)
plt.yticks(fontsize=16)

plt.tight_layout()
plt.savefig('Proton_pot_w_slope_Y730_C439.pdf')
plt.clf()
...
plt.tight_layout()
plt.savefig('Proton_pot_adiabatic_Y730_C439.pdf')
