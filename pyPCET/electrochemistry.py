...
def EDL_model(EvsSHE, dIHL, dOHL, eps_IHL, eps_st, eps_op, dipole, rho_solvent, m_solvent, c_ions, C_EDL, PZFCvsSHE, T=298.15, eta_Kirkwood=1, g_Kirkwood=2.4, print_data=True):
    """
